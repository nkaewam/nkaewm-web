...
<section class="references">
  ...
  <ol>
    ...
    <li id="ref-2">ByteDance Seed. <a href="https://huggingface.co/ByteDance-Seed/Seed-Coder-8B-Base">"Seed-Coder-8B-Base."</a> Hugging Face, 2025.</li>
